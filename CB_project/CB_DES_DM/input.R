...
lambda_IHD <- cons[2,] + indiv_data %*% ukpds_param_v2[2,]
param_IHD  <- data.frame("lambda" = lambda_CHF, "rho"= param2[2,], "dist" = dist_cq[2,])
lambda_death <- cons[3,] + indiv_data %*% ukpds_param_v2[3,]
param_death  <- data.frame("lambda" = lambda_CHF, "rho"= param2[3,], "dist" = dist_cq[3,])
